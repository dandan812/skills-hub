export const resources = {
  en: {
    translation: {
      ...
      runtimeEvidence: {
        title: 'Skill runtime',
        subtitle: 'Installed, assigned, loaded, and recent-call evidence',
        refresh: 'Refresh evidence',
        loading: 'Reading runtime evidence...',
        unavailable: 'Runtime evidence is available only in the desktop app.',
        error: 'Runtime evidence could not be read',
        summary: 'Runtime evidence summary',
        events: 'Events',
        imported: 'Imported',
        rejected: 'Rejected',
        dataState: 'Data',
        rejectedDetail: '{{count}} event(s) were rejected. Hover to view reason codes.',
        agent: 'Agent',
        session: 'Session',
        noSession: 'No observed session',
        search: 'Search Skills',
        noResults: 'No matching Skills',
        noSkills: 'No managed or observed Skills',
        inbox: 'JSONL inbox',
        ...
        columns: {
          ...
          installed: 'Installed',
          assigned: 'Assigned',
          loaded: 'Loaded this session',
          lastCall: 'Recent call',
        ...
        sources: {
          managementCatalog: 'Skills Hub catalog',
          localHookReported: 'Local Hook reported',
          catalogAndLocalHookReported: 'Catalog + local Hook',
          unknown: 'Unknown',
        },
      },
      newSkill: 'New Skill',
  ...
  zh: {
    translation: {
      ...
      runtimeEvidence: {
        title: 'Skill 运行状态',
        subtitle: '安装、分配、会话加载与最近调用证据',
        refresh: '刷新证据',
        loading: '正在读取运行时证据...',
        unavailable: '运行时证据仅可在桌面应用中读取。',
        error: '无法读取运行时证据',
        summary: '运行时证据摘要',
        events: '事件',
        imported: '已导入',
        rejected: '已拒绝',
        dataState: '数据',
        rejectedDetail: '有 {{count}} 条事件被拒绝，悬停可查看原因代码。',
        agent: 'Agent',
        session: '会话',
        noSession: '暂无观测会话',
        search: '搜索 Skills',
        noResults: '没有匹配的 Skill',
        noSkills: '暂无已管理或已观测的 Skill',
        inbox: 'JSONL 入口',
        ...
        sources: {
          managementCatalog: 'Skills Hub 目录',
          localHookReported: '本地 Hook 报告',
          catalogAndLocalHookReported: '目录 + 本地 Hook',
          unknown: '未知',
        },
      },
      newSkill: '新建 Skill',
